...
public class StudentRepositoryImpl implements StudentRepository {
    ...
    private static final String BLOCK_STUDENT="UPDATE student SET student.status='Заблокирован' WHERE student.login=?";
    private static final String UNBLOCK_STUDENT="UPDATE student SET student.status='Разблокирован' WHERE student.login=?";
    ...
    @Override
    public void registerStudentOnCourse(Student student, int courseId, Connection connection) throws SQLQueryException, StudentAlreadyRegisteredException, MaxAmountOfRegistrationException, BlockedStudentException {
        log.info(student);
        if (student.getStatus().equals("Заблокирован")) {
            throw new BlockedStudentException(Messages.BLOCKED_STUDENT);
        }
        String studentQuery;
